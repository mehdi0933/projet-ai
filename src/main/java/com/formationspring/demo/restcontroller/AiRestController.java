...
public class AiRestController {
    ...
    public ResponseEntity<List<AiDto.PostOutput>> getHistory(@PathVariable String mail) {
      List<AiDto.PostOutput> history = aiHistoryRecorderService.findAllPostByMail(mail);
